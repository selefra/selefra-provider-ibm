# Selefra Provider IBM

Use this repo as a raw reference to **tables and schema** for IBM usage. [Here's](https://github.com/selefra/selefra-provider-ibm/blob/main/docs/tables/ibm.md) a summary of full coverage. 
