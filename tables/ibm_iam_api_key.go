...
type TableIbmIamApiKeyGenerator struct {
}

var _ table_schema_generator.TableSchemaGenerator = &TableIbmIamApiKeyGenerator{}

func (x *TableIbmIamApiKeyGenerator) GetTableName() string {
	return "ibm_iam_api_key"
}

func (x *TableIbmIamApiKeyGenerator) GetTableDescription() string {
	return ""
}

func (x *TableIbmIamApiKeyGenerator) GetVersion() uint64 {
	return 0
}

func (x *TableIbmIamApiKeyGenerator) GetOptions() *schema.TableOptions {
	return &schema.TableOptions{}
}

func (x *TableIbmIamApiKeyGenerator) GetDataSource() *schema.DataSource {
...
func (x *TableIbmIamApiKeyGenerator) GetExpandClientTask() func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) []*schema.ClientTaskContext {
	return nil
}

func (x *TableIbmIamApiKeyGenerator) GetColumns() []*schema.Column {
...
func (x *TableIbmIamApiKeyGenerator) GetSubTables() []*schema.Table {
	return nil
}
